...
urlpatterns = [
    ...
    #  path('users/login/', views.,
    #     {'template_name': 'login.html'}, name='login'),
    url(r'^users/login/$', auth_views.LoginView.as_view(),
        {'template_name': 'login.html'}, name='login'),
    url(r'^users/logout/$', auth_views.LogoutView.as_view(),
        {'next_page': '/'}, name='logout'),
    url(r'^users/change_password/$',
        login_required(auth_views.PasswordChangeView.as_view()),
        {'post_change_redirect': '/home', 'template_name':
         'change_password.html'}, name='change_password'),
]
